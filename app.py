...
import pathlib
import dash
from dash import Dash, dcc, html, Output, State, Input, dash_table
    ...
    return html.Div(
        ...
        children=[
            html.Div(
                id="banner-text",
                children=[
                    html.H5("Dashboard de manufacturation."),
                    html.H6("Processus de controle et de reporting."),
                ],
            ),
            html.Div(
                id="banner-logo",
                children=[
                    html.A(
                        html.Button(children="BOUTTON 1"),
                        href="https://plotly.com/get-demo/",
                    ),
                    html.Button(
                        id="learn-more-button", children="EN SAVOIR PLUS", n_clicks=0
                    ),
                    html.A(
        ...
        children=[
            dcc.Tabs(
                ...
                children=[
                    dcc.Tab(
                        id="Specs-tab",
                        label="Parametres de specification",
                        value="tab1",
                ...
                html.Div(
                    ...
                    children=[
                        html.Label(
                            ...
                            children="Selectionnez une metrique",
                        ),
                        html.Br(),
                        dcc.Dropdown(
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                                html.Button(
                                    "Mettre a jour ", id="value-setter-set-btn"
                                ),
                                html.Button(
                                    "Etat courant",
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    generate_section_banner(
                        "Résumé des métriques de contrôle de processus"
                    ),
                    html.Div(
                        id="metric-div",
                        children=[
            ...
            html.Div(
                ...
                children=[
                    generate_section_banner("% OOC par parametres"),
                    generate_piechart(),
                ],
            ),
        ],
...
def generate_metric_list_header():
    return generate_metric_row(
        ...
        {"id": "m_header_2", "children": html.Div("Conteur")},
        {"id": "m_header_3", "children": html.Div("Line")},
        {"id": "m_header_4", "children": html.Div("OOC%")},
        {"id": "m_header_5", "children": html.Div("%OOC")},
        {"id": "m_header_6", "children": "Passe/Echec"},
    )
    ...
    return generate_metric_row(
        ...
        None,
        {
            ...
            "children": html.Button(
                ...
                children=item,
                title="Cliquez pour visualiser le graphique SPC en direct",
                n_clicks=0,
            ),
        },
...
def build_chart_panel():
    return html.Div(
        ...
        className="twelve columns",
        children=[
            generate_section_banner("Graphique SPC en direct"),
            dcc.Graph(
